...
<body class="bg-gray-100">
    ...
    <div class="flex flex-col items-center p-2">
        <h2 class="p-4 text-3xl"><b>Edytuj rezerwacje:</b></h2>
        <form class="form-inline rounded-md bg-gray-500" action="<?=config('app.url'); ?>/rezerwacje/update/{{$rezerwacje->id_rezerwacji}}" method="post">
            ...
            <p class="p-4">
                ...
                <input id="id_klienta" name="id_klienta" value="{{$rezerwacje->id_klienta}}" required>
            </p>
            <p class="p-4">
                <label for="id_samochodu">Id samochodu:</label>
                <input id="id_samochodu" name="id_samochodu" value="{{$rezerwacje->id_samochodu}}" required>
            </p>
            <p class="p-4">
                <label for="data_pocz">Data początkowa:</label>
                <input id="data_pocz" name="data_pocz" type="date" value="{{$rezerwacje->data_pocz}}" required>
            </p>
            <p class="p-4">
                <label for="data_kon">Data końcowa:</label>
                <input id="data_kon" name="data_kon" type="date" value="{{$rezerwacje->data_kon}}" required>
            </p>
            <p class="p-4">
