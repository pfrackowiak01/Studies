...
public class Tabu_Search {
    ...
    static int MAX_ITER = 5000;       // Ilość wykonań pętli algorytmu
    ...
    static public void przeszukiwanieTabu() {                    // Algorytm przeszukiwania Tabu
        ...
        //wybierz_rozwiazanie_poczatkowe_losowe();                 // wariant 1, 3
        wybierz_rozwiazanie_poczatkowe_najoptymalniejsze();    // wariant 2, 4
        System.arraycopy(vc, 0, best, 0, n);
        do {
            //wybierz_rozwiazanie_z_otoczenia();                 // wariant 1, 2
            wybierz_rozwiazanie_z_otoczenia2();                  // wariant 3, 4
