...
var kol=db.cities_A.find({"certificate_number":{$gt:4000}},{_id:1,certificate_number:1});
while (kol.hasNext()){print(kol.next());}

// Policzenie wszystkich dokumentow
var ile=db.cities_A.find({"certificate_number":{$gt:4000}},{_id:1,certificate_number:1}).count();
