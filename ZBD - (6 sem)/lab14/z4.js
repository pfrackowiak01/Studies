...
function szukaj(miasto_f,vat,n,m) {
...
var dane = db.kol1.aggregate([
{
	...
	},
	{
		$addFields: {
			...
			wynagr_brutto:{$multiply: ["$k2.wynagr_netto",vat]},
			miasto:"$k2.miasto"
		}
	},
	{
		$match: {wynagr_netto:{$gte:n},wynagr_netto:{$lte:m},miasto:miasto_f}
	},
	{
	...
	},
{
	...
	{
		$match: {wynagr_brutto:{$gt:srednia},wynagr_netto:{$gte:n},wynagr_netto:{$lte:m},miasto:miasto_f}
	},
	{
